...
{
  $str = 'https://gcore.jsdelivr.net/gh/liaohengfeng/joe/assets/images/AvatarLazyload.png';
  if ($type) echo $str;
  else return $str;
}
...
function getThumbnails($item)
{
  ...
  if (sizeof($result) < 3) {
    ...
    if ($custom_thumbnail) {
      ...
      for ($i = 0; $i < 3; $i++) {
        $result[] = 'https://gcore.jsdelivr.net/npm/typecho-joe-next@6.0.0/assets/thumb/' . rand(1, 42) . '.jpg';
      }
    }
  }
  return $result;
